...
signed int main()
{

  {
    ...
    Tensor tenFive = ((create)(1, ({
      signed int  *__dimsize_tmp7 = ((malloc)((1 * (sizeof(signed int)))));;
      signed int __dimsize_tmp8[] = {9};;
      ((memcpy)((__dimsize_tmp7), (__dimsize_tmp8), (1 * (sizeof(signed int))))); })
    , 9, ({
      float __data_tmp9[] = {1, 2, 3, 4, 5, (-1), 2, 2, 95};;
      float  *__data_tmp10 = ((malloc)((9 * (sizeof(float)))));;
      ((memcpy)((__data_tmp10), (__data_tmp9), (9 * (sizeof(float))))); })
    ));;
    if ((((max)((tenOne))) != 2))
    {
      {
    ...
    if (((ten_not_equals)(((ten_min)((tenFive))), (tenFiveMin))))
    {
      {
        return 1;
      }
    ...
    if (((ten_not_equals)(((ten_sum)((tenFive))), (tenFiveSum))))
    {
      {
        return 1;
      }
    ...
    if (((ten_not_equals)(((ten_prod)((tenFive))), (tenFiveProd))))
    {
      {
        return 1;
      }
