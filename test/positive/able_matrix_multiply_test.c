...
signed int main()
{

  {
    Tensor tenOne = ((create)(2, ({
      signed int  *__dimsize_tmp19 = ((malloc)((2 * (sizeof(signed int)))));;
      signed int __dimsize_tmp20[] = {3, 3};;
      ((memcpy)((__dimsize_tmp19), (__dimsize_tmp20), (2 * (sizeof(signed int))))); })
    , 9, ({
      float __data_tmp21[] = {9, 10, 21, 32, 53, 12, 43, 4, 10};;
      float  *__data_tmp22 = ((malloc)((9 * (sizeof(float)))));;
      ((memcpy)((__data_tmp22), (__data_tmp21), (9 * (sizeof(float))))); })
    ));;
    Tensor tenTwo = ((create)(2, ({
      signed int  *__dimsize_tmp35 = ((malloc)((2 * (sizeof(signed int)))));;
      signed int __dimsize_tmp36[] = {3, 5};;
      ((memcpy)((__dimsize_tmp35), (__dimsize_tmp36), (2 * (sizeof(signed int))))); })
    , 15, ({
      float __data_tmp37[] = {12, 43, 65, 34, 23, 6, 7, 2, 45, 20, 40, 21, 65, 7, 69};;
      float  *__data_tmp38 = ((malloc)((15 * (sizeof(float)))));;
      ((memcpy)((__data_tmp38), (__data_tmp37), (15 * (sizeof(float))))); })
    ));;
    Tensor tenThree = ((create)(2, ({
      signed int  *__dimsize_tmp59 = ((malloc)((2 * (sizeof(signed int)))));;
      signed int __dimsize_tmp60[] = {5, 4};;
      ((memcpy)((__dimsize_tmp59), (__dimsize_tmp60), (2 * (sizeof(signed int))))); })
    , 20, ({
      float __data_tmp61[] = {1, 3, 6, 2, 12, 64, 29, 5, 39, 492, 42, 45, 65, 23, 56, 23, 12, 45, 12, 34};;
      float  *__data_tmp62 = ((malloc)((20 * (sizeof(float)))));;
      ((memcpy)((__data_tmp62), (__data_tmp61), (20 * (sizeof(float))))); })
    ));;
    Tensor tenFour = ((create)(2, ({
      signed int  *__dimsize_tmp79 = ((malloc)((2 * (sizeof(signed int)))));;
      signed int __dimsize_tmp80[] = {4, 2};;
      ((memcpy)((__dimsize_tmp79), (__dimsize_tmp80), (2 * (sizeof(signed int))))); })
    , 8, ({
      float __data_tmp81[] = {666, 555, 444, 333, 222, 111, 45, 2};;
      float  *__data_tmp82 = ((malloc)((8 * (sizeof(float)))));;
      ((memcpy)((__data_tmp82), (__data_tmp81), (8 * (sizeof(float))))); })
    ));;
    Tensor tenOneTwo = ((create)(2, ({
      signed int  *__dimsize_tmp95 = ((malloc)((2 * (sizeof(signed int)))));;
      signed int __dimsize_tmp96[] = {3, 5};;
      ((memcpy)((__dimsize_tmp95), (__dimsize_tmp96), (2 * (sizeof(signed int))))); })
    , 15, ({
      float __data_tmp97[] = {1008, 898, 1970, 903, 1856, 1182, 1999, 2966, 3557, 2624, 940, 2087, 3453, 1712, 1759};;
      float  *__data_tmp98 = ((malloc)((15 * (sizeof(float)))));;
      ((memcpy)((__data_tmp98), (__data_tmp97), (15 * (sizeof(float))))); })
    ));;
    Tensor tenTwoThree = ((create)(2, ({
      signed int  *__dimsize_tmp111 = ((malloc)((2 * (sizeof(signed int)))));;
      signed int __dimsize_tmp112[] = {3, 4};;
      ((memcpy)((__dimsize_tmp111), (__dimsize_tmp112), (2 * (sizeof(signed int))))); })
    , 12, ({
      float __data_tmp113[] = {5549, 36585, 6229, 4728, 3333, 3385, 3083, 1852, 4110, 36710, 4799, 5617};;
      float  *__data_tmp114 = ((malloc)((12 * (sizeof(float)))));;
      ((memcpy)((__data_tmp114), (__data_tmp113), (12 * (sizeof(float))))); })
    ));;
    Tensor tenThreeFour = ((create)(2, ({
      signed int  *__dimsize_tmp135 = ((malloc)((2 * (sizeof(signed int)))));;
      signed int __dimsize_tmp136[] = {5, 2};;
      ((memcpy)((__dimsize_tmp135), (__dimsize_tmp136), (2 * (sizeof(signed int))))); })
    , 10, ({
      float __data_tmp137[] = {3420, 2224, 43071, 31201, 255771, 190233, 66969, 49996, 32166, 23045};;
      float  *__data_tmp138 = ((malloc)((10 * (sizeof(float)))));;
      ((memcpy)((__data_tmp138), (__data_tmp137), (10 * (sizeof(float))))); })
    ));;
    if (((ten_not_equals)(((ten_multiply)((tenOne), (tenTwo))), (tenOneTwo))))
    {
      {
        return 1;
      }
    ...
    if (((ten_not_equals)(((ten_multiply)((tenTwo), (tenThree))), (tenTwoThree))))
    {
      {
        return 1;
      }
    ...
    if (((ten_not_equals)(((ten_multiply)((tenThree), (tenFour))), (tenThreeFour))))
    {
      {
        return 1;
      }
