...
signed int main()
{

  {
    ...
    if (((ten_not_equals)(((ten_trace)((idTwo))), (idTwoTrace))))
    {
      {
        return 1;
      }
    ...
    if (((ten_not_equals)(((ten_trace)((testThree))), (testThreeTrace))))
    {
      {
        return 1;
      }
