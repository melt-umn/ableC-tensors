...
signed int main()
{

  {
    ...
    Tensor tenOneTrans = ((create)(2, ({
      signed int  *__dimsize_tmp51 = ((malloc)((2 * (sizeof(signed int)))));;
      signed int __dimsize_tmp52[] = {3, 3};;
      ((memcpy)((__dimsize_tmp51), (__dimsize_tmp52), (2 * (sizeof(signed int))))); })
    , 9, ({
      float __data_tmp53[] = {9, 32, 43, 10, 53, 4, 21, 12, 10};;
      float  *__data_tmp54 = ((malloc)((9 * (sizeof(float)))));;
      ((memcpy)((__data_tmp54), (__data_tmp53), (9 * (sizeof(float))))); })
    ));;
    Tensor tenTwoTrans = ((create)(2, ({
      signed int  *__dimsize_tmp75 = ((malloc)((2 * (sizeof(signed int)))));;
      signed int __dimsize_tmp76[] = {5, 3};;
      ((memcpy)((__dimsize_tmp75), (__dimsize_tmp76), (2 * (sizeof(signed int))))); })
    , 15, ({
      float __data_tmp77[] = {12, 6, 40, 43, 7, 21, 65, 2, 65, 34, 45, 7, 23, 20, 69};;
      float  *__data_tmp78 = ((malloc)((15 * (sizeof(float)))));;
      ((memcpy)((__data_tmp78), (__data_tmp77), (15 * (sizeof(float))))); })
    ));;
    if (((ten_not_equals)(((trans)((tenOne))), (tenOneTrans))))
    {
      {
        return 1;
      }
    ...
    if (((ten_not_equals)(((trans)((tenTwo))), (tenTwoTrans))))
    {
      {
        ((printT)(((trans)((tenTwo)))));
        return 1;
    ...
    signed int  *dataTestThree;;
    ((dataTestThree) = ((malloc)(((sizeof(signed int)) * 2))));
    (((dataTestThree)[0]) = 2);
    (((dataTestThree)[1]) = 5);
    signed int  *dataTestThreeTrans;;
    ((dataTestThreeTrans) = ((malloc)(((sizeof(signed int)) * 2))));
    (((dataTestThreeTrans)[0]) = 5);
    (((dataTestThreeTrans)[1]) = 2);
    signed int  *dataTestFour;;
    ((dataTestFour) = ((malloc)(((sizeof(signed int)) * 2))));
    (((dataTestFour)[0]) = 1);
    (((dataTestFour)[1]) = 6);
    signed int  *dataTestFourTrans;;
    ((dataTestFourTrans) = ((malloc)(((sizeof(signed int)) * 2))));
    ...
    if (((ten_not_equals)(((trans)((fillThree))), (fillThreeTrans))))
    {
      {
        return 1;
      }
    ...
    if (((ten_not_equals)(((trans)((fillFour))), (fillFourTrans))))
    {
      {
        return 1;
      }
