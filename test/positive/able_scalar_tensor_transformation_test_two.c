...
signed int main()
{
  ...
  {
    signed int intOne = 5;;
    signed int intTwo = 666;;
    signed int intThree = (-12);;
    ...
    , 1, ({
      float __data_tmp9[] = {(intOne)};;
      float  *__data_tmp10 = ((malloc)((1 * (sizeof(float)))));;
      ((memcpy)((__data_tmp10), (__data_tmp9), (1 * (sizeof(float))))); })
    ));;
    Tensor tenOneTensor = ((create)(1, ({
      signed int  *__dimsize_tmp11 = ((malloc)((1 * (sizeof(signed int)))));;
      signed int __dimsize_tmp12[] = {1};;
      ((memcpy)((__dimsize_tmp11), (__dimsize_tmp12), (1 * (sizeof(signed int))))); })
    , 1, ({
      float __data_tmp13[] = {5};;
      float  *__data_tmp14 = ((malloc)((1 * (sizeof(float)))));;
      ((memcpy)((__data_tmp14), (__data_tmp13), (1 * (sizeof(float))))); })
    ));;
    if (((ten_not_equals)((tenOne), (tenOneTensor))))
    {
      {
        return 1;
      }
    ...
    Tensor tenTwo = ((create)(1, ({
      signed int  *__dimsize_tmp18 = ((malloc)((1 * (sizeof(signed int)))));;
      signed int __dimsize_tmp19[] = {1};;
      ((memcpy)((__dimsize_tmp18), (__dimsize_tmp19), (1 * (sizeof(signed int))))); })
    , 1, ({
      float __data_tmp20[] = {(intTwo)};;
      float  *__data_tmp21 = ((malloc)((1 * (sizeof(float)))));;
      ((memcpy)((__data_tmp21), (__data_tmp20), (1 * (sizeof(float))))); })
    ));;
    Tensor tenTwoTensor = ((create)(1, ({
      signed int  *__dimsize_tmp22 = ((malloc)((1 * (sizeof(signed int)))));;
      signed int __dimsize_tmp23[] = {1};;
      ((memcpy)((__dimsize_tmp22), (__dimsize_tmp23), (1 * (sizeof(signed int))))); })
    , 1, ({
      float __data_tmp24[] = {666};;
      float  *__data_tmp25 = ((malloc)((1 * (sizeof(float)))));;
      ((memcpy)((__data_tmp25), (__data_tmp24), (1 * (sizeof(float))))); })
    ));;
    if (((ten_not_equals)((tenTwo), (tenTwoTensor))))
    {
      {
        return 1;
      }
    ...
    Tensor tenThree = ((create)(1, ({
      signed int  *__dimsize_tmp26 = ((malloc)((1 * (sizeof(signed int)))));;
      signed int __dimsize_tmp27[] = {1};;
      ((memcpy)((__dimsize_tmp26), (__dimsize_tmp27), (1 * (sizeof(signed int))))); })
    , 1, ({
      float __data_tmp28[] = {(intThree)};;
      float  *__data_tmp29 = ((malloc)((1 * (sizeof(float)))));;
      ((memcpy)((__data_tmp29), (__data_tmp28), (1 * (sizeof(float))))); })
    ));;
    Tensor tenThreeTensor = ((create)(1, ({
      signed int  *__dimsize_tmp30 = ((malloc)((1 * (sizeof(signed int)))));;
      signed int __dimsize_tmp31[] = {1};;
      ((memcpy)((__dimsize_tmp30), (__dimsize_tmp31), (1 * (sizeof(signed int))))); })
    , 1, ({
      float __data_tmp32[] = {(-12)};;
      float  *__data_tmp33 = ((malloc)((1 * (sizeof(float)))));;
      ((memcpy)((__data_tmp33), (__data_tmp32), (1 * (sizeof(float))))); })
    ));;
    if (((ten_not_equals)((tenThree), (tenThreeTensor))))
    {
      {
        return 1;
      }
