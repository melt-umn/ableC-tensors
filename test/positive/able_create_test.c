...
signed int main()
{
  ...
  {
    signed int i;;
    signed int dimZero = 0;;
    signed int dimOne = 1;;
    signed int dimTwo = 2;;
    signed int dimThree = 3;;
    signed int  *dimSizeZero = (((void *)0));;
    signed int  *dimSizeOne = ((malloc)((sizeof(signed int))));;
    (((dimSizeOne)[0]) = 1);
    signed int  *dimSizeTwo = ((malloc)(((sizeof(signed int)) * 2)));;
    (((dimSizeTwo)[0]) = 3);
    (((dimSizeTwo)[1]) = 3);
    signed int  *dimSizeThree = ((malloc)(((sizeof(signed int)) * 3)));;
    (((dimSizeThree)[0]) = 2);
    (((dimSizeThree)[1]) = 3);
    (((dimSizeThree)[2]) = 3);
    signed int countZero = 1;;
    signed int countOne = 1;;
    signed int countTwo = 9;;
    signed int countThree = 18;;
