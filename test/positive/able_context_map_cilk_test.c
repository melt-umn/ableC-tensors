...
Tensor add_first_to_all(Tensor  ten)
{

  {
    ...
    ((map_with_context_cilk)((add_to_elem), (ten), (&(elem_to_add))));
    return (ten);
  }
}
...
signed int main()
{

  {
    Tensor tenOne = ((create)(1, ({
      ...
      signed int __dimsize_tmp12[] = {9};;
      ((memcpy)((__dimsize_tmp11), (__dimsize_tmp12), (1 * (sizeof(signed int))))); })
    , 9, ({
      float __data_tmp13[] = {1, 2, 3, 4, 5, 6, 7, 8, 9};;
      float  *__data_tmp14 = ((malloc)((9 * (sizeof(float)))));;
      ((memcpy)((__data_tmp14), (__data_tmp13), (9 * (sizeof(float))))); })
    ));;
    Tensor tenOneAdd = ((create)(1, ({
      signed int  *__dimsize_tmp15 = ((malloc)((1 * (sizeof(signed int)))));;
      signed int __dimsize_tmp16[] = {9};;
      ((memcpy)((__dimsize_tmp15), (__dimsize_tmp16), (1 * (sizeof(signed int))))); })
    , 9, ({
      float __data_tmp17[] = {2, 3, 4, 5, 6, 7, 8, 9, 10};;
      float  *__data_tmp18 = ((malloc)((9 * (sizeof(float)))));;
      ((memcpy)((__data_tmp18), (__data_tmp17), (9 * (sizeof(float))))); })
    ));;
    Tensor tenTwo = ((create)(2, ({
      signed int  *__dimsize_tmp31 = ((malloc)((2 * (sizeof(signed int)))));;
      signed int __dimsize_tmp32[] = {3, 3};;
      ((memcpy)((__dimsize_tmp31), (__dimsize_tmp32), (2 * (sizeof(signed int))))); })
    , 9, ({
      float __data_tmp33[] = {3, 4, 5, 6, 7, 8, 9, 8, 7};;
      float  *__data_tmp34 = ((malloc)((9 * (sizeof(float)))));;
      ((memcpy)((__data_tmp34), (__data_tmp33), (9 * (sizeof(float))))); })
    ));;
    Tensor tenTwoAdd = ((create)(2, ({
      signed int  *__dimsize_tmp47 = ((malloc)((2 * (sizeof(signed int)))));;
      signed int __dimsize_tmp48[] = {3, 3};;
      ((memcpy)((__dimsize_tmp47), (__dimsize_tmp48), (2 * (sizeof(signed int))))); })
    , 9, ({
      float __data_tmp49[] = {6, 7, 8, 9, 10, 11, 12, 11, 10};;
      float  *__data_tmp50 = ((malloc)((9 * (sizeof(float)))));;
      ((memcpy)((__data_tmp50), (__data_tmp49), (9 * (sizeof(float))))); })
    ));;
    Tensor tenThree = ((create)(3, ({
      signed int  *__dimsize_tmp75 = ((malloc)((3 * (sizeof(signed int)))));;
      signed int __dimsize_tmp76[] = {2, 2, 1};;
      ((memcpy)((__dimsize_tmp75), (__dimsize_tmp76), (3 * (sizeof(signed int))))); })
    , 4, ({
      float __data_tmp77[] = {0, 0, 1, 1};;
      float  *__data_tmp78 = ((malloc)((4 * (sizeof(float)))));;
      ((memcpy)((__data_tmp78), (__data_tmp77), (4 * (sizeof(float))))); })
    ));;
    Tensor tenThreeAdd = ((create)(3, ({
      signed int  *__dimsize_tmp103 = ((malloc)((3 * (sizeof(signed int)))));;
      signed int __dimsize_tmp104[] = {2, 2, 1};;
      ((memcpy)((__dimsize_tmp103), (__dimsize_tmp104), (3 * (sizeof(signed int))))); })
    , 4, ({
      float __data_tmp105[] = {0, 0, 1, 1};;
      float  *__data_tmp106 = ((malloc)((4 * (sizeof(float)))));;
      ((memcpy)((__data_tmp106), (__data_tmp105), (4 * (sizeof(float))))); })
    ));;
    if (((ten_not_equals)(((add_first_to_all)((tenOne))), (tenOneAdd))))
    {
      {
        return 1;
      }
    ...
    if (((ten_not_equals)(((add_first_to_all)((tenTwo))), (tenTwoAdd))))
    {
      {
        return 1;
      }
    ...
    if (((ten_not_equals)(((add_first_to_all)((tenThree))), (tenThreeAdd))))
    {
      {
        return 1;
      }
