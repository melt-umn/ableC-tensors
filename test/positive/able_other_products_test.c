...
signed int main()
{
  ...
  {
    Tensor tenZero = ((create)(1, ({
      signed int  *__dimsize_tmp7 = ((malloc)((1 * (sizeof(signed int)))));;
      signed int __dimsize_tmp8[] = {3};;
      ((memcpy)((__dimsize_tmp7), (__dimsize_tmp8), (1 * (sizeof(signed int))))); })
    , 3, ({
      float __data_tmp9[] = {666, 662, 35};;
      float  *__data_tmp10 = ((malloc)((3 * (sizeof(float)))));;
      ((memcpy)((__data_tmp10), (__data_tmp9), (3 * (sizeof(float))))); })
    ));;
    Tensor tenOne = ((create)(1, ({
      signed int  *__dimsize_tmp11 = ((malloc)((1 * (sizeof(signed int)))));;
      signed int __dimsize_tmp12[] = {3};;
      ((memcpy)((__dimsize_tmp11), (__dimsize_tmp12), (1 * (sizeof(signed int))))); })
    , 3, ({
      float __data_tmp13[] = {22, 1234, 2};;
      float  *__data_tmp14 = ((malloc)((3 * (sizeof(float)))));;
      ((memcpy)((__data_tmp14), (__data_tmp13), (3 * (sizeof(float))))); })
    ));;
    Tensor tenTwo = ((create)(1, ({
      signed int  *__dimsize_tmp15 = ((malloc)((1 * (sizeof(signed int)))));;
      signed int __dimsize_tmp16[] = {3};;
      ((memcpy)((__dimsize_tmp15), (__dimsize_tmp16), (1 * (sizeof(signed int))))); })
    , 3, ({
      float __data_tmp17[] = {32, 543, 65};;
      float  *__data_tmp18 = ((malloc)((3 * (sizeof(float)))));;
      ((memcpy)((__data_tmp18), (__data_tmp17), (3 * (sizeof(float))))); })
    ));;
    Tensor tenZeroOneTwoScalar = ((create)(1, ({
      signed int  *__dimsize_tmp19 = ((malloc)((1 * (sizeof(signed int)))));;
      signed int __dimsize_tmp20[] = {1};;
      ((memcpy)((__dimsize_tmp19), (__dimsize_tmp20), (1 * (sizeof(signed int))))); })
    , 1, ({
      float __data_tmp21[] = {50828320};;
      float  *__data_tmp22 = ((malloc)((1 * (sizeof(float)))));;
      ((memcpy)((__data_tmp22), (__data_tmp21), (1 * (sizeof(float))))); })
    ));;
    Tensor tenOneZeroTwoScalar = ((create)(1, ({
      signed int  *__dimsize_tmp23 = ((malloc)((1 * (sizeof(signed int)))));;
      signed int __dimsize_tmp24[] = {1};;
      ((memcpy)((__dimsize_tmp23), (__dimsize_tmp24), (1 * (sizeof(signed int))))); })
    , 1, ({
      float __data_tmp25[] = {(-50828324)};;
      float  *__data_tmp26 = ((malloc)((1 * (sizeof(float)))));;
      ((memcpy)((__data_tmp26), (__data_tmp25), (1 * (sizeof(float))))); })
    ));;
    Tensor tenTwoZeroOneScalar = ((create)(1, ({
      signed int  *__dimsize_tmp27 = ((malloc)((1 * (sizeof(signed int)))));;
      signed int __dimsize_tmp28[] = {1};;
      ((memcpy)((__dimsize_tmp27), (__dimsize_tmp28), (1 * (sizeof(signed int))))); })
    , 1, ({
      float __data_tmp29[] = {50828320};;
      float  *__data_tmp30 = ((malloc)((1 * (sizeof(float)))));;
      ((memcpy)((__data_tmp30), (__data_tmp29), (1 * (sizeof(float))))); })
    ));;
    float tenZeroOneTwoFloat = 50828320;;
    float tenOneZeroTwoFloat = (-50828324);;
    float tenTwoZeroOneFloat = 50828320;;
    Tensor tenZeroOneTwoVector = ((create)(1, ({
      signed int  *__dimsize_tmp31 = ((malloc)((1 * (sizeof(signed int)))));;
      signed int __dimsize_tmp32[] = {3};;
      ((memcpy)((__dimsize_tmp31), (__dimsize_tmp32), (1 * (sizeof(signed int))))); })
    , 3, ({
      float __data_tmp33[] = {(-18184994), 21112312, (-53289844)};;
      float  *__data_tmp34 = ((malloc)((3 * (sizeof(float)))));;
      ((memcpy)((__data_tmp34), (__data_tmp33), (3 * (sizeof(float))))); })
    ));;
    Tensor tenOneZeroTwoVector = ((create)(1, ({
      signed int  *__dimsize_tmp35 = ((malloc)((1 * (sizeof(signed int)))));;
      signed int __dimsize_tmp36[] = {3};;
      ((memcpy)((__dimsize_tmp35), (__dimsize_tmp36), (1 * (sizeof(signed int))))); })
    , 3, ({
      float __data_tmp37[] = {420204576, (-7441938), (-30574590)};;
      float  *__data_tmp38 = ((malloc)((3 * (sizeof(float)))));;
      ((memcpy)((__data_tmp38), (__data_tmp37), (3 * (sizeof(float))))); })
    ));;
    Tensor tenTwoZeroOneVector = ((create)(1, ({
      signed int  *__dimsize_tmp39 = ((malloc)((1 * (sizeof(signed int)))));;
      signed int __dimsize_tmp40[] = {3};;
      ((memcpy)((__dimsize_tmp39), (__dimsize_tmp40), (1 * (sizeof(signed int))))); })
    , 3, ({
      float __data_tmp41[] = {438389568, (-28554250), 22715254};;
      float  *__data_tmp42 = ((malloc)((3 * (sizeof(float)))));;
      ((memcpy)((__data_tmp42), (__data_tmp41), (3 * (sizeof(float))))); })
    ));;
    if (((ten_not_equals)((tenZeroOneTwoScalar), ((scalar_triple_product)((tenZero), (tenOne), (tenTwo))))))
    {
      {
        return 1;
      }
    ...
    if (((ten_not_equals)((tenOneZeroTwoScalar), ((scalar_triple_product)((tenOne), (tenZero), (tenTwo))))))
    {
      {
        return 1;
      }
    ...
    if (((ten_not_equals)((tenTwoZeroOneScalar), ((scalar_triple_product)((tenTwo), (tenZero), (tenOne))))))
    {
      {
        return 1;
      }
    ...
    if (((ten_not_equals)((tenZeroOneTwoVector), ((vector_triple_product)((tenZero), (tenOne), (tenTwo))))))
    {
      {
        return 1;
      }
    ...
    if (((ten_not_equals)((tenOneZeroTwoVector), ((vector_triple_product)((tenOne), (tenZero), (tenTwo))))))
    {
      {
        return 1;
      }
    ...
    if (((ten_not_equals)((tenTwoZeroOneVector), ((vector_triple_product)((tenTwo), (tenZero), (tenOne))))))
    {
      {
        return 1;
      }
