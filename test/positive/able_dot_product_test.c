...
signed int main()
{

  {
    ...
    ((dotOne) = ((create)(1, ({
      signed int  *__dimsize_tmp10 = ((malloc)((1 * (sizeof(signed int)))));;
      signed int __dimsize_tmp11[] = {1};;
      ((memcpy)((__dimsize_tmp10), (__dimsize_tmp11), (1 * (sizeof(signed int))))); })
    , 1, ({
      float __data_tmp12[] = {90};;
      float  *__data_tmp13 = ((malloc)((1 * (sizeof(float)))));;
      ((memcpy)((__data_tmp13), (__data_tmp12), (1 * (sizeof(float))))); })
    )));
    ((dotTwo) = ((create)(1, ({
      signed int  *__dimsize_tmp14 = ((malloc)((1 * (sizeof(signed int)))));;
      signed int __dimsize_tmp15[] = {1};;
      ((memcpy)((__dimsize_tmp14), (__dimsize_tmp15), (1 * (sizeof(signed int))))); })
    , 1, ({
      float __data_tmp16[] = {17982};;
      float  *__data_tmp17 = ((malloc)((1 * (sizeof(float)))));;
      ((memcpy)((__data_tmp17), (__data_tmp16), (1 * (sizeof(float))))); })
    )));
    ((dotThree) = ((create)(1, ({
    ...
    if (((ten_not_equals)((dotTwo), ((dot_product)((tenTwoF), (tenTwoS))))))
    {
      {
        return 1;
      }
    ...
    if (((ten_not_equals)((dotThree), ((dot_product)((tenThreeF), (tenThreeS))))))
    {
      {
        return 1;
      }
    ...
    if (((ten_not_equals)((dotFour), ((dot_product)((tenFourF), (tenFourS))))))
    {
      {
        return 1;
      }
    ...
    if ((90 != ((float_dot_product)((tenOneF), (tenOneS)))))
    {
      {
        return 1;
      }
    ...
    if ((17982 != ((float_dot_product)((tenTwoF), (tenTwoS)))))
    {
      {
        return 1;
      }
