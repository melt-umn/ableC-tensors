...
signed int main()
{

  {
    ...
    Tensor crossZeroOne = ((create)(1, ({
      signed int  *__dimsize_tmp19 = ((malloc)((1 * (sizeof(signed int)))));;
      signed int __dimsize_tmp20[] = {3};;
      ((memcpy)((__dimsize_tmp19), (__dimsize_tmp20), (1 * (sizeof(signed int))))); })
    , 3, ({
      float __data_tmp21[] = {(-41866), (-562), 807280};;
      float  *__data_tmp22 = ((malloc)((3 * (sizeof(float)))));;
      ((memcpy)((__data_tmp22), (__data_tmp21), (3 * (sizeof(float))))); })
    ));;
    Tensor crossOneZero = ((create)(1, ({
    ...
    , 3, ({
      float __data_tmp25[] = {41866, 562, (-807280)};;
      float  *__data_tmp26 = ((malloc)((3 * (sizeof(float)))));;
      ((memcpy)((__data_tmp26), (__data_tmp25), (3 * (sizeof(float))))); })
    ));;
    Tensor crossZeroTwo = ((create)(1, ({
      signed int  *__dimsize_tmp27 = ((malloc)((1 * (sizeof(signed int)))));;
      signed int __dimsize_tmp28[] = {3};;
      ((memcpy)((__dimsize_tmp27), (__dimsize_tmp28), (1 * (sizeof(signed int))))); })
    , 3, ({
      float __data_tmp29[] = {24025, (-42170), 340454};;
      float  *__data_tmp30 = ((malloc)((3 * (sizeof(float)))));;
      ((memcpy)((__data_tmp30), (__data_tmp29), (3 * (sizeof(float))))); })
    ));;
    Tensor crossOneTwo = ((create)(1, ({
    ...
    , 3, ({
      float __data_tmp33[] = {79124, (-1366), (-27542)};;
      float  *__data_tmp34 = ((malloc)((3 * (sizeof(float)))));;
      ((memcpy)((__data_tmp34), (__data_tmp33), (3 * (sizeof(float))))); })
    ));;
    if (((ten_not_equals)((crossZeroOne), ((cross_product)((tenZero), (tenOne))))))
    {
      {
        return 1;
      }
    ...
    if (((ten_not_equals)((crossOneZero), ((cross_product)((tenOne), (tenZero))))))
    {
      {
        return 1;
      }
    ...
    if (((ten_not_equals)((crossZeroTwo), ((cross_product)((tenZero), (tenTwo))))))
    {
      {
        return 1;
      }
    ...
    if (((ten_not_equals)((crossOneTwo), ((cross_product)((tenOne), (tenTwo))))))
    {
      {
        return 1;
      }
