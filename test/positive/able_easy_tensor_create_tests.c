...
signed int main()
{
  ...
  {
    signed int  *dataTestOne;;
    ((dataTestOne) = ((malloc)((sizeof(signed int)))));
    (((dataTestOne)[0]) = 1);
    ...
    , 1, ({
      float __data_tmp12[] = {666};;
      float  *__data_tmp13 = ((malloc)((1 * (sizeof(float)))));;
      ((memcpy)((__data_tmp13), (__data_tmp12), (1 * (sizeof(float))))); })
    ));;
    Tensor fillTwoSyn = ((create)(1, ({
      signed int  *__dimsize_tmp14 = ((malloc)((1 * (sizeof(signed int)))));;
      signed int __dimsize_tmp15[] = {3};;
      ((memcpy)((__dimsize_tmp14), (__dimsize_tmp15), (1 * (sizeof(signed int))))); })
    , 3, ({
      float __data_tmp16[] = {666, 666, 666};;
      float  *__data_tmp17 = ((malloc)((3 * (sizeof(float)))));;
      ((memcpy)((__data_tmp17), (__data_tmp16), (3 * (sizeof(float))))); })
    ));;
    if (((ten_not_equals)((fillOne), (fillOneSyn))))
    {
      {
        return 1;
      }
    ...
    if (((ten_not_equals)((fillTwo), (fillTwoSyn))))
    {
      {
        return 1;
      }
    ...
    if (((ten_not_equals)((onesThree), (fillThree))))
    {
      {
        return 1;
      }
    ...
    if (((ten_not_equals)((zerosFour), (fillFour))))
    {
      {
        return 1;
      }
